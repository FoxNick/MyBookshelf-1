...
public interface IStationBookModel {
     ...
     * 网络解析图书目录
     */
    Observable<List<BookChapterBean>> getChapterList(BookShelfBean bookShelfBean);

    /**
     * 章节缓存
     */
    Observable<BookContentBean> getBookContent(final BaseChapterBean chapterBean, final BaseChapterBean nextChapterBean, final BookShelfBean bookShelfBean);
